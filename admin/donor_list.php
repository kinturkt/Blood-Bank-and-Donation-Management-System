          ...
          <tr>
                  ...
                  <td><?php echo $row['donor_gender']; ?></td>
                    ...
                    <td id="he" style="width:120px">
                      <a style="background-color:orange; padding: 2px 8px; color: #000;" href='update_donor.php?id=<?php echo $row['donor_id']; ?>'>Edit</a>
                      <a style="background-color:crimson; padding: 2px 8px; color: #fff; margin-left: 5px;" href='delete.php?id=<?php echo $row['donor_id']; ?>' onclick="return confirm('Are you sure you want to delete this donor?');">Delete</a>
                    </td>
