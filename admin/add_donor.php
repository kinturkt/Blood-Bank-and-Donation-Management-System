      ...
      <div class="container-fluid">
        ...
        <?php if (isset($_GET['status'])): ?>
          <?php if ($_GET['status'] == 'success'): ?>
            <div class="alert alert-success">Donor added successfully!</div>
          <?php elseif ($_GET['status'] == 'error'): ?>
            <div class="alert alert-danger">Error adding donor. Please try again.</div>
          <?php endif; ?>
        <?php endif; ?>
        ...
        <form name="donor" action="save_donor_data.php" method="post">
          <div class="row">
            ...
            <div class="col-lg-4 mb-4"><br>
              ...
              <input type="text" name="mobileno" class="form-control" pattern="\d{10}" title="Enter 10-digit number" required>
            </div>
            <div class="col-lg-4 mb-4"><br>
